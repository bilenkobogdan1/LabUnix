...
void dine()
{
...

    {
        ...
        {
           {
              { "philosoph 1", table, table.forks[0], table.forks[1] },
              { "philosoph 2",    table, table.forks[1], table.forks[2] },
              { "philosoph 3", table, table.forks[2], table.forks[3] },
              { "philosoph 4",      table, table.forks[3], table.forks[4] },
              { "philosoph 5", table, table.forks[4], table.forks[0] },
           }
        };
